/**
 * Example: CLI sync script using Contrail as a library.
 *
 * Usage:
 *   npx tsx examples/cloudflare-workers/sync.ts           # local D1
 *   npx tsx examples/cloudflare-workers/sync.ts --remote  # prod D1
 */
import { Contrail } from "../../src/index";
import { config } from "./config";

// For Cloudflare D1, use wrangler's getPlatformProxy:
